...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.subfinal.widget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.subfinal.widget.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(TOAST_ACTION)) {
                Intent mainIntent = new Intent(context, MainView.class);
