...
import com.example.favoritecatalogue.adapter.FavoriteMovieAdapter;
import com.example.favoritecatalogue.model.Movie;
import com.example.favoritecatalogue.viewmodel.FavoriteMovieViewModel;
...
public class FavoriteMovieView extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.setMovies(getContext());
